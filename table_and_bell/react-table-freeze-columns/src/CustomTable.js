...
const generateColumnBordersCSS = (columnBorders) => {
  ...
  const Styles = ({ children, config, rowCount }) => {
    const { headerStyles, rowStyles, generalCSS, borderBetweenColumns, borderBetweenRows, hideTopHeaderRow, hideDimensionHeader, bodyStyle, headerColor, fixedHeight, unsetTable, odd, weightHeader, weightTable, fontColor, tableFontSize, headFontSize, headBorder, stripe, headerFontColor, verticalStripe } = config;
