...
export interface VisDimension {
  name: string;
  type: string;
  title: string;
}

export interface VisMeasure {
  name: string;
  type: string;
  title: string;
}

export type MassBalanceMeasures = "Inflow" | "Outflow" | "Storage" | "Usage";

export interface ChartMapRecord {
  color?: string;
  element?: HTMLElement;
  chart?: Chart;
  label?: string;
...
export type MassBalanceChartMap = Record<MassBalanceMeasures, ChartMapRecord>;
